...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.user && response.data.user.role === "admin") navigate("/admin");
            ...
            <div className="hidden lg:flex w-1/2 flex-col justify-center items-center relative overflow-hidden bg-slate-50 border-l border-slate-100">
                ...
                >
                    ...
                    <h2 className="text-3xl font-bold mb-4 text-slate-900 tracking-tight">
                        Artisan pizza,<br/>delivered to you.
                    </h2>
                    <p className="text-slate-500 text-sm leading-relaxed px-4">
                        Experience the finest ingredients and authentic recipes in every bite. Your next favorite slice is just a click away.
                    </p>
                </motion.div>
            </div>
        </div>
